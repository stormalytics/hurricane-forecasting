...
#                'reg__estimator__criterion': ['squared_error', 'friedman_mse', 'absolute_error'],
...
# search = GridSearchCV(pipe, param_grid, cv=5, n_jobs=11, verbose=1,
...
# error_distances = haversine(y_pred, y)
...
reg = MultiOutputRegressor(xgb.XGBRegressor(verbosity=2, n_jobs=12))
